...
gsub(incident_df$Date,pattern=" 0:00",replacement="",fixed=T)
...
#print(airlines)
#airline$code <- NA
#airline$aid <- NA#dbWriteTable(conn=mydb, name='airlines', value=airlines, append=TRUE, row.names=FALSE, field.types=c())
